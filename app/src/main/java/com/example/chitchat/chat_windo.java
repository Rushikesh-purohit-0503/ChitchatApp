...
public class chat_windo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mmessagesAdpter = new messagesAdapter(chat_windo.this, messagesArrayList,messageAdpter);
        ...
        chatreference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                mmessagesAdpter.scrollToLastItem();
            }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    // Ensure 'profilePic' node exists within the snapshot
